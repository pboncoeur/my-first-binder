...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Billing Software || GUI || By Pabitra Banerjee")
        bg_color = "#badc57"
        title = Label(self.root, text="Billing Software || GUI || By Pabitra Banerjee", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#badc57", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
